...
<nav class="navbar navbar-light w-auto justify-content-space-between mb-1" style="background: none !important; height: 4rem;">

      <!--  HOME  -->
      <a class="nav-item nav-link active pt-4 " href="../index.php" style="padding: 0;">
      <i class="fas fa-home fa-2x text-primary"></i> <span class="sr-only">(current)</span></a>


      <!--  DIRECTORY  -->
      <a class="nav-item nav-link ml-4 mr-3 pt-3" href="#" style="padding: 0;">
      <i id="nav-list" class="fas fa-list-alt fa-2x text-danger"></i></a>
      ...
      <i class="fas fa-search fa-2x bg-black text-danger" style="border-radius: 50%; color: black;"></i></a>


      <!--  LOGIN  -->
      <a class="nav-item nav-link pt-4" href="#" style="padding: 0;">
      <i id="login-dropdown" class="fas fa-user-circle fa-2x text-primary"></i></a>
